...
export const stack: StackItem[] = [
  ...
  { name: 'Nest', link: 'https://nestjs.com/', icon: 'custom:nest' },
  { name: 'TailwindCSS', link: 'https://tailwindcss.com/', icon: 'custom:tailwind' },
  { name: 'Prisma', link: 'https://www.prisma.io/', icon: 'custom:prisma' },
  { name: 'Vercel', link: 'https://vercel.com/', icon: 'custom:vercel' },
  { name: 'Figma', link: 'https://www.figma.com/', icon: 'custom:figma' },
  { name: 'Notion', link: 'https://www.notion.so/', icon: 'custom:notion' },
  { name: 'Photoshop', link: 'https://www.adobe.com/products/photoshop.html', icon: 'custom:photoshop' },
  { name: 'Illustrator', link: 'https://www.adobe.com/products/illustrator.html', icon: 'custom:illustrator' },
]
